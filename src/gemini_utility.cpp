...
int simulation_start_up(string & _sim_file, string & _results_directory)
{
    ...
    _sim_file = "GEMINI_file.csv";                    //default simulation file
    _results_directory = "GEMINI_Results";                    //default name of results directory
...
int return_coordinates_WG(double width, double height, double length,int npml, double dl,
...
int return_coordinates_2D(double width, double height,int npmlx,int npmly,
