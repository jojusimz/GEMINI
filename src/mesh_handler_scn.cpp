             ...
             double tfactor, float er, float sigma_ey,int scn_typ, int n_PMl, int conduct_prof,double Refn_factor)
{
    ...
    {   neighbours_set = false;
       ...
       //Reserve memory for mesh_handler_SCN nodes
...
//2D_SCN
mesh_handler_SCN::mesh_handler_SCN(double width, double height, int simtype, double dl, double tfactor,
             float er, float sigma_ey, int scn_typ, int n_PMl, int conduct_prof,double Refn_factor)
{
...
mesh_handler_SCN::mesh_handler_SCN(const mesh_handler_SCN& copy_mesh_handler_SCN)
{
    WG_width = copy_mesh_handler_SCN.WG_width;
    WG_height = copy_mesh_handler_SCN.WG_height;
    WG_length = copy_mesh_handler_SCN.WG_length;
    WG_dl = copy_mesh_handler_SCN.WG_dl;            // discretization length
    WG_PML_length = copy_mesh_handler_SCN.WG_PML_length;
    sim_type = copy_mesh_handler_SCN.sim_type;
    Nx = copy_mesh_handler_SCN.Nx;                 //number of nodes on the x , y and z axis
    Ny = copy_mesh_handler_SCN.Ny;
    Nz = copy_mesh_handler_SCN.Nz;
    Nzz = copy_mesh_handler_SCN.Nzz;
    Nxx = copy_mesh_handler_SCN.Nxx;
    Nyy = copy_mesh_handler_SCN.Nyy;
    npml = copy_mesh_handler_SCN.npml;
    centre_node = copy_mesh_handler_SCN.centre_node;         //node of excitation for short dipole - default set to -1 if waveguide
    WG_Ex = copy_mesh_handler_SCN.WG_Ex;
    WG_Ey = copy_mesh_handler_SCN.WG_Ey;
    Ey_outputs = copy_mesh_handler_SCN.Ey_outputs;
    WG_Ez = copy_mesh_handler_SCN.WG_Ez;
    WG_Hx = copy_mesh_handler_SCN.WG_Hx;
    WG_Hy = copy_mesh_handler_SCN.WG_Hy;
    WG_Hz = copy_mesh_handler_SCN.WG_Hz;
    average_Ey = copy_mesh_handler_SCN.average_Ey;
    WG_Ey_plane_xy = copy_mesh_handler_SCN.WG_Ey_plane_xy;
    WG_Ey_plane_yz = copy_mesh_handler_SCN.WG_Ey_plane_yz;
    WG_Ey_plane_zx = copy_mesh_handler_SCN.WG_Ey_plane_zx;
    Ey_field_along_line = copy_mesh_handler_SCN.Ey_field_along_line;
    Ntotal= copy_mesh_handler_SCN.Ntotal;
    Ntotal_ = copy_mesh_handler_SCN.Ntotal_;
    WG_nodes = copy_mesh_handler_SCN.WG_nodes;   // represents the waveguide nodes; this is set in the constructor depending on the simulation parameters.
    WG_node_neighbours= copy_mesh_handler_SCN.WG_node_neighbours;
    check_meshed = copy_mesh_handler_SCN.check_meshed;         //checks if the waveguide has been meshed / filled with cubes
    neighbours_set = copy_mesh_handler_SCN.neighbours_set;
    scn_type = copy_mesh_handler_SCN.scn_type;
    V_incident_xy = copy_mesh_handler_SCN.V_incident_xy;
}

mesh_handler_SCN &mesh_handler_SCN::operator=(const mesh_handler_SCN& copy_mesh_handler_SCN)
{
    if (this!= &copy_mesh_handler_SCN)
    {
    WG_width = copy_mesh_handler_SCN.WG_width;
    WG_height = copy_mesh_handler_SCN.WG_height;
    WG_length = copy_mesh_handler_SCN.WG_length;
 ...
 mesh_handler_SCN::~mesh_handler_SCN()
{
...
double mesh_handler_SCN::compute_field_average_in_z_plane(int z_plane)
{
...
vector<double> mesh_handler_SCN::compute_field_along_line( int x_plane_id, int y_plane, int z_plane_id)
{
...
int mesh_handler_SCN::get_true_centre_node()
{
    return(centre_node);
}

void mesh_handler_SCN::set_special_nodes()
{
...
void mesh_handler_SCN::place_dipole_antenna(double dipole_length, int x, int y, int z )
{
...
void mesh_handler_SCN::insert_iris(int thickness , float z_plane)
{
    if (2*thickness < Nyy)
    {
...
void mesh_handler_SCN::insert_perfect_cube(int cube_l,int nx0,int ny0, int nz0) // cube_l == full dimension of cube
{
    int Nxy = Nxx*Nyy;
...
void mesh_handler_SCN::insert_square_loop(double sq_length, int x, int y, int z )
{
...
void mesh_handler_SCN::insert_PML(int num_PML, double loc, double Reflctn_f, int c_profile, int scn_typ)
{
        if( loc > WG_length)
        {
            cout<< " error !" <<endl;
...
void mesh_handler_SCN::print_WG_plane_par(int z_plane, int par )
{
    cout<<" Plane : " << z_plane << endl;
...
void mesh_handler_SCN::TLM_excitation_te10(int node , double v_inc)
{
        double start_node = 0;
        double v = 0, v_ = 0;
...
void mesh_handler_SCN::TLM_excitation_single_node(int node , double v_inc, int axis,int source_res)
{
...
void mesh_handler_SCN::TLM_excitation_plane_node(int node, double v_inc)
{
   int nxy = Nyy*Nxx;
   double v = 0, v_ = 0;
   int start_node = node;
...
void mesh_handler_SCN::TLM_excitation_by_imposing_inc(int start_node_z, vector <double> scn_inc )
{
   int nxy = Nyy*Nxx;
   int temp;
...
void mesh_handler_SCN::TLM_simulation1(int dt_total,double tfactor, int output_node,int excited_node,
...
void mesh_handler_SCN::create_connect_bins()
{
...
void mesh_handler_SCN::TLM_connection_optimized(double Zz1 , double Zz2, double Zy1, double Zy2, double Zx1, double Zx2 )
{
   // variable definitions
    int nny = this->Nyy;
    int nnx = this->Nxx;
...
void mesh_handler_SCN::print_connect_bins()
{
...
void mesh_handler_SCN:: write_output_file (const string& nodefileEX,const string& nodefileEY, const string& nodefileEZ, const string& nodefileHX,const string& nodefileHY,const string& nodefileHZ)                                           //writes to node file
{
...
void mesh_handler_SCN:: write_output_file_for_yz_plane (const string& nodefileEY)                                           //writes to node file
{
    ofstream out_fileEY;
...
void mesh_handler_SCN:: write_output_file_for_line (const string& nodefileEY)                                           //writes to node file
{
...
void mesh_handler_SCN:: write_output_file_for_xy_plane (const string& nodefileEY)                                           //writes to node file
{
    ofstream out_fileEY;
...
void mesh_handler_SCN:: write_output_file_for_zx_plane (const string& nodefileEY)                                           //writes to node file
{
    ofstream out_fileEY;
...
void mesh_handler_SCN :: write_incident_file_for_xy_plane (const string& nodefileEY)
{
    ofstream out_fileEY;
...
void mesh_handler_SCN::print_Ez_output()
{
...
bool mesh_handler_SCN::print_G_PML_parameters(int L_R,int PML_layer)
{
...
//.................FUNCTIONS BELOW THIS LINE ARE NO LONGER IN USE AND WILL BE DELETED IN FUTURE UPDATES..............................
//.................FUNCTIONS BELOW THIS LINE ARE NO LONGER IN USE AND WILL BE DELETED IN FUTURE UPDATES..............................
//.................FUNCTIONS BELOW THIS LINE ARE NO LONGER IN USE AND WILL BE DELETED IN FUTURE UPDATES..............................
//.................FUNCTIONS BELOW THIS LINE ARE NO LONGER IN USE AND WILL BE DELETED IN FUTURE UPDATES..............................
//.................FUNCTIONS BELOW THIS LINE ARE NO LONGER IN USE AND WILL BE DELETED IN FUTURE UPDATES..............................
...
void mesh_handler_SCN::TLM_simulation_2D_SCN(int dt_total,double tfactor, int output_node,int excited_node,double Zz1, double Zz2, double Zy1, double Zy2,double Zx1, double Zx2, f_gaussian func, double z)
{
...
void mesh_handler_SCN::TLM_connection(double Zz1 , double Zz2, double Zy1, double Zy2, double Zx1, double Zx2 )
{
   // Variable Definitions
    int nny = this->Nyy;
    int nnx = this->Nxx;
...
void mesh_handler_SCN::TLM_connection_2D_SCN_wg(double Zz1 , double Zz2, double Zy1, double Zy2, double Zx1, double Zx2 )
{
     if( Ny >1)
     {
        int a;
...
void mesh_handler_SCN::TLM_connection_2D_SCN(double Zz1 , double Zz2, double Zy1, double Zy2, double Zx1, double Zx2 )
{
    // Variable Definitions
    int nny = this->Nyy;
    int nnx = this->Nxx;
...
void mesh_handler_SCN::TLM_connection_sd(double Zz1 , double Zz2, double Zy1, double Zy2, double Zx1, double Zx2 )
{
...
vector<double> mesh_handler_SCN::compute_far_field(const vector<int> &plane_xy1)
{
